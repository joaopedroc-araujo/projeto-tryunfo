...
const FrameComponent1 = () => {
  return (
    <div className="self-stretch grid flex-row items-start justify-start gap-[25px] max-w-full grid-cols-[repeat(3,_minmax(269px,_1fr))] text-left text-base-6 text-white font-epilogue mq750:grid-cols-[minmax(269px,_1fr)] mq1050:justify-center mq1050:grid-cols-[repeat(2,_minmax(269px,_466px))]">
      <div className="rounded-[9.73px] bg-white shadow-[0px_3.9px_13px_rgba(0,_0,_0,_0.5)] flex flex-row items-center justify-center pt-[9px] pb-[11px] pr-[9px] pl-2.5 box-border max-w-full shrink-0 z-[1]">
        ...
        <div className="flex-1 rounded-[9.73px] bg-teal flex flex-col items-end justify-end py-[75px] pr-0 pl-[21px] box-border relative min-h-[514px] max-w-full z-[1]">
          ...
          <div className="my-0 mx-[!important] absolute top-[19px] left-[calc(50%_-_154.5px)] w-[310px] flex flex-col items-end justify-start pt-0 px-0 pb-[39px] box-border gap-[120px] bg-cover bg-no-repeat bg-[top] z-[2]">
            <img
              className="self-stretch relative max-w-full overflow-hidden h-[270.6px] shrink-0 object-cover hidden"
              alt=""
